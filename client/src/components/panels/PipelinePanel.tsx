          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div key={step.id} className="relative">
                ...
                {idx !== steps.length - 1 && (
                  <div
                    className={`absolute left-6 top-14 bottom-[-1.5rem] w-[2px] transition-colors duration-500 ${
                      isComplete
                ...
                >
                  ...
                  >
                    ...
                    {isActive && step.id === "verifying" && (
                      <>
                        ...
                        <div
                          className="absolute inset-0 rounded-full border border-primary/50 animate-radar"
                  ...
                  <div className="pt-2 flex-1">
                    <h3
                      className={`font-bold tracking-wide ${isActive ? "text-primary" : isComplete ? (isFailed ? "text-destructive" : "text-success") : "text-white"}`}
                    >
                      {step.title}
                    </h3>
                    <p className="text-sm text-muted-foreground mt-1">
                      {txStep === "error" && step.id === "verifying"
                        ? "Service Failure Detected: Initiating Atomic Refund"
                        : step.desc}
                    </p>
